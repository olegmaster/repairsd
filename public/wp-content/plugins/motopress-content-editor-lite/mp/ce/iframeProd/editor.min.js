...
c.each(parent.motopressCE.styleEditor.presets,function(b,d){a.presetStyles[b]=new CE.ShortcodePresetStyle(b,d.settings,d.css,d.label)})},initEvents:function(){parent.MP.Editor.onIfr("AfterUpdate",this.proxy("clearPresetsField"))},getPresetsLastId:function(){return this.presetsLastId},incPresetsLastId:function(){this.presetsLastId++;return this.presetsLastId},initPrivateStyles:function(){var a=this;this.prefixPrivateClass=parent.motopressCE.styleEditor["const"].prefixPrivateClass;this.privateMetaField=
parent.CE.Navbar.myThis.privatesMetaField;c.each(this.getPrivateStylesMeta(),function(b,d){a.privateStyles[b]=new CE.ShortcodePrivateStyle(b,d.settings)})},udpatePrivateStylesMeta:function(){this.privateMetaField.val(this.getPrivateStylesString());parent.CE.Save.changeContent()},getPrivateStylesMeta:function(){return c.parseJSON(this.privateMetaField.val())},getPrivateStylesString:function(){var a={};c.each(this.privateStyles,function(b,d){d.isEmpty()||(a[b]={settings:d.getSettings(),css:d.getCSS()})});
return JSON.stringify(a)},getPrivateStyleInstance:function(a){a=this.retrievePrivateClass(a);if(""!==a&&this.privateStyles.hasOwnProperty(a))return this.privateStyles[a];a=this.generatePrivateClass();return this.createPrivateStyle(a)},getPresetStyleInstance:function(a){a=this.retrievePresetClass(a);return this.isExistsPreset(a)?this.presetStyles[a]:null},createPrivateStyle:function(a,b){this.privateStyles[a]=new CE.ShortcodePrivateStyle(a,b);return this.privateStyles[a]},retrievePrivateClass:function(a){a=
(new RegExp("(?:^|\\s)+("+this.prefixPrivateClass+"[\\d]+-[\\S]+)(?:$|\\s)+")).exec(a);return null!==a&&2===a.length?a[1]:""},generatePrivateClass:function(){var a=parent.MP.Utils.uniqid(this.prefixPrivateClass+parent.motopressCE.postID+"-");return this.privateStyles.hasOwnProperty(a)?this.generatePrivateClass():a},getPresetsString:function(){var a={};c.each(this.presetStyles,function(b,d){a[b]={settings:d.getSettings(),css:d.getCSS(),label:d.getLabel()}});return JSON.stringify(a)},getPresetsList:function(a){var b=
{};c.each(this.presetStyles,function(a,c){b[c.getClassName()]=c.getLabel()});a&&(b=c.extend({"":localStorage.getItem("CENone")},b));return b},getPresetsListSelect2:function(){var a=[];c.each(this.presetStyles,function(b,d){a.push({id:d.getClassName(),text:d.getLabel()})});return a},generatePresetClassName:function(){return this.prefixPresetClass+this.incPresetsLastId()},createPreset:function(a,b){var d=this.generatePresetClassName();""===a&&(a=this.presetDefaultLabel+this.getPresetsLastId());this.presetStyles[d]=
new CE.ShortcodePresetStyle(d,b,void 0,a);this.updatePresetStylesMeta();return this.presetStyles[d]},deletePreset:function(a){this.isExistsPreset(a)&&(this.presetStyles[a]["delete"](),delete this.presetStyles[a],this.updatePresetStylesMeta());return!0},updatePresetStylesMeta:function(){parent.motopressCE.styleEditor.presets=this.presetStyles;this.presetsLastIdMetaField.val(this.getPresetsLastId());this.presetsMetaField.val(this.getPresetsString());parent.CE.Save.changeContent()},clearPresetsField:function(){this.presetsLastIdMetaField.val("");
this.presetsMetaField.val("")},isExistsPreset:function(a){return this.presetStyles.hasOwnProperty(a)},retrievePresetClass:function(a){a=(new RegExp("(?:^|\\s)+("+this.prefixPresetClass+"[\\d]+)(?:$|\\s)+")).exec(a);return null!==a&&2===a.length?a[1]:""},changePrivateClassToDuplicated:function(a){if(""!==a){var b=CE.StyleEditor.myThis.retrievePrivateClass(a);if(""!==b){var d=CE.StyleEditor.myThis.duplicatePrivateStyle(b);a=a.replace(b,d.getClassName())}}return a},duplicatePrivateStyle:function(a){var b=
this.generatePrivateClass();a=this.privateStyles.hasOwnProperty(a)?this.createPrivateStyle(b,this.privateStyles[a].getSettings()):this.createPrivateStyle(b);this.udpatePrivateStylesMeta();return a},setEmulateCSSMode:function(){this.emulateCSSMode=!0;c.each(this.presetStyles,function(){this.updateStyleTag()});c.each(this.privateStyles,function(){this.updateStyleTag()})},unsetEmulateCSSMode:function(){this.emulateCSSMode=!1;c.each(this.presetStyles,function(){this.updateStyleTag()});c.each(this.privateStyles,
...
library:{type:"image"},contentUserSetting:!0,syncSelection:!0});this.frame.on("open",this.proxy("onOpen"));this.frame.on("select",this.proxy("setImage"));this.frame.on("close",this.proxy("onClose"))},onOpen:function(){var a=this.frame;a.reset();this.propertyImage=CE.Dialog.myThis.element.find('[data-motopress-open-img-lib="1"]');var b=this.propertyImage.control().get();null!==b&&""!==b&&(c.isArray(b)||(b=[b]),b.forEach(function(b){jQuery.isNumeric(b)&&(b=parent.wp.media.attachment(b),b.fetch(),a.state().get("selection").add(b))}))},
setImage:function(){var a=this.frame.state().get("selection").models[0].attributes,b="full";a.sizes.hasOwnProperty("medium")?b="medium":a.sizes.hasOwnProperty("thumbnail")&&(b="thumbnail");var b=a.sizes[b].url,d=this.propertyImage.control();d.set({id:a.id,src:b,full:a.sizes.full.url});d.showTools();d.element.trigger("change");this.propertyImage.removeAttr("data-motopress-open-img-lib")},onClose:function(){c("."+CE.Dialog.myThis.dialogClass).focus();var a=c(parent.document).find("html, body");a.addClass("motopress-ce-jumping-fix");
var b=setTimeout(function(){a.removeClass("motopress-ce-jumping-fix");clearTimeout(b)},0)}})}(jQuery),function(c){CE.Link=can.Construct({myThis:null,wpLink:null,submitCallback:null,closeCallback:null,inputs:{}},{init:function(){CE.Link.myThis=this;CE.Link.wpLink=parent.wpLink;CE.Link.inputs.submit=c("#wp-link-submit",parent.document);CE.Link.inputs.cancel=c("#wp-link-cancel",parent.document);parent.MP.Utils.version_compare(parent.motopressCE.settings.wp.wordpress_version,"4.2",">=")?(CE.Link.inputs.url=
c("#wp-link-url",parent.document),CE.Link.inputs.title=c("#wp-link-text",parent.document),CE.Link.inputs.openInNewTab=c("#wp-link-target",parent.document)):(CE.Link.inputs.url=c("#url-field",parent.document),CE.Link.inputs.title=c("#link-title-field",parent.document),CE.Link.inputs.openInNewTab=c("#link-target-checkbox",parent.document));c("#wp-link-classes",parent.document).length||c("#link-options .link-target",parent.document).before('<div class="wp-link-classes-field">\n<label><span>'+localStorage.getItem("CELinkClass")+
...
e);parent.wpActiveEditor=parent.tinyMCE.activeEditor.id;var g=null;CE.Link.wpLink.setDefaultValues=function(){var b=null,d=null;c.isPlainObject(a)?(g=a.href,b="_blank"===a.target?!0:!1,d=a.textarea):(g=a.val(),d=a);if(""===g||"#"===g)g="http://";CE.Link.inputs.url.val(g);CE.Link.inputs.openInNewTab.prop("checked",b);CE.Link.inputs.classes.val("");CE.Link.wpLink.textarea=d};CE.Link.wpLink.open();g||(g=c.isPlainObject(a)?a.href:a.val(),CE.Link.inputs.url.val(g));"undefined"===typeof CE.Link.inputs.close&&
(CE.Link.inputs.close=c(".ui-dialog-titlebar-close",parent.document));CE.Link.inputs.close.off("mousedown.motopress-wplink-close").on("mousedown.motopress-wplink-close",e);f.url||CE.Link.inputs.url.closest("div").hide();f.title||CE.Link.inputs.title.closest("div").hide();f.target||CE.Link.inputs.openInNewTab.closest("div").hide();CE.Link.inputs.classes.closest("div").show();parent.CE.Iframe.myThis.wpLinkCloseCallback(this.onDialogClose)}},wpCancelButtonHandler:function(a){CE.Link.wpLink.close();return!1},
wpSubmitButtonHandler:function(a){a=CE.Link.wpLink.getAttrs();if(a.href&&"http://"!=a.href)return a.classes=CE.Link.inputs.classes.val(),CE.Link.submitCallback&&CE.Link.submitCallback(a),CE.Link.wpLink.close(),!1},onDialogClose:function(){CE.Link.inputs.submit.off("mousedown.motopress-wplink-submit");CE.Link.inputs.close.off("mousedown.motopress-wplink-close");CE.Link.inputs.url.closest("div").show();CE.Link.inputs.title.closest("div").show();CE.Link.inputs.openInNewTab.closest("div").show();CE.Link.inputs.classes.closest("div").hide()}})}(jQuery),
...
switch(this.getMode()){case "tabs":this.setTitle(a.shortcodeLabel);break;case "style-editor":var b=this.styleEditorContainer.children().control();this.setTitle(a.shortcodeLabel+" - "+b.getTitle())}},getMode:function(){return this.mode},init:function(){CE.Dialog.myThis=this;var a=null,b=!1,d=0,e=parent.MP.Utils.version_compare(c.fn.jquery,"1.9.0","<");sessionStorage.getItem("motopressDialogLeft");sessionStorage.getItem("motopressDialogTop");var f={my:"right-20 top+20",at:"right top",of:window},g=sessionStorage.getItem("motopressDialogWidth"),
l=sessionStorage.getItem("motopressDialogHeight");null===g&&(g=300);null===l&&(l=400);c.ui.dialog.prototype._focusTabbable=function(){};this.element.dialog({autoOpen:!1,closeOnEscape:!0,closeText:"",dialogClass:this.dialogClass,draggable:!0,modal:!1,position:f,resizable:!0,minWidth:280,width:g,minHeight:280,height:l,maxHeight:c(window).height(),create:function(){CE.Dialog.myThis.dialog=CE.Dialog.myThis.element.dialog("widget");a=CE.Dialog.myThis.dialog;a.on("resizestart",function(a,f){b=c(a.originalEvent.target).hasClass("ui-resizable-n");
d=c(document).scrollTop();e&&(b||c(this).css("top",parseInt(c(this).css("top"))-d))});a.on("resize",function(a,f){e&&b&&c(this).css("top",parseInt(c(this).css("top"))-d)});a.on("resizestop",function(a,b){CE.Dialog.myThis.savePosition(b);CE.Dialog.myThis.saveSize(b)});c(this).prev(".ui-dialog-titlebar").find(".ui-dialog-titlebar-close").before(CE.Dialog.myThis.minimizeRestoreBtn);var f=a.draggable("option","cancel")+", .ui-dialog-titlebar-minimize, .ui-dialog-titlebar-restore";a.draggable("option",
"cancel",f);CE.Dialog.myThis.minimizeRestoreBtn.on("click",function(){c(this).hasClass("ui-dialog-titlebar-minimize")?CE.Dialog.myThis.minimize():CE.Dialog.myThis.restore()})},dragStart:function(a,b){CE.LeftBar.myThis.disable()},dragStop:function(a,b){CE.Dialog.myThis.savePosition(b);CE.LeftBar.myThis.enable()},close:function(){CE.Dialog.myThis.close()},beforeClose:function(a,b){},open:function(){var b=c("."+CE.Selectable.myThis.selectedClass);b.length&&CE.Selectable.focusWithoutScroll(CE.Selectable.getFocusAreaBySelected(b));
if("minimized"===sessionStorage.getItem("motopressDialogState"))a.css("left","auto");else{var b=parseInt(sessionStorage.getItem("motopressDialogLeft")),d=parseInt(sessionStorage.getItem("motopressDialogTop")),e=a.width(),f=a.height(),g=c(window).width(),l=c(window).height();f>l&&(f=l,a.height(f));0>d?a.css("top",0):f<l&&d+f>l?a.css("top",l-f):d+f>l?a.css("top",l-f):a.css("top",d);0>b?a.css("left",0):e<g&&b+e>g?a.css("left",g-e):a.css("left",b)}},resizeStart:function(){CE.LeftBar.myThis.disable()},
...
sessionStorage.getItem("motopressDialogState")===this.state.minimized&&this.minimize(),b=a?this.styleTitle.index():this.settingsTitle.index(),d=this.shortcode.attr("data-motopress-dialog-tab"),"undefined"!==typeof d&&(b=d),a?this.tabs.tabs("disable",this.settingsTitle.index()):!1!==this.tabs.tabs("option","disabled")&&this.tabs.tabs("enable",this.settingsTitle.index()),this.tabs.tabs("option","active",b),this.element.dialog("open"),this.element.find(".motopress-controls").trigger("dialogOpen"))}},
close:function(){"style-editor"===this.getMode()&&this.styleEditorContainer.children().control().confirm();this.setTitle();var a=c("."+CE.Selectable.myThis.selectedClass);a.length&&CE.Selectable.focusWithoutScroll(CE.Selectable.getFocusAreaBySelected(a))},setTitle:function(a){a="undefined"!==typeof a?a:"";"string"===typeof a&&(this.element.dialog("option","title",a),this.element.dialog("widget").find(".ui-dialog-title").attr("title",a))},savePosition:function(a){sessionStorage.setItem("motopressDialogLeft",
this.dialog.css("left"));sessionStorage.setItem("motopressDialogTop",this.dialog.css("top"))},saveSize:function(a){sessionStorage.setItem("motopressDialogWidth",a.size.width);sessionStorage.setItem("motopressDialogHeight",a.size.height)},minimize:function(){this.minimizeRestoreBtn.removeClass("ui-dialog-titlebar-minimize").addClass("ui-dialog-titlebar-restore");sessionStorage.setItem("motopressDialogState",this.state.minimized);this.dialog.removeClass("motopress-dialog-"+this.state.restored).addClass("motopress-dialog-"+
this.state.minimized);var a=c(window).width()-this.dialog.width();this.dialog.css("left",a);sessionStorage.setItem("motopressDialogLeft",this.dialog.css("left"));this.element.dialog("option","draggable",!1)},restore:function(){this.minimizeRestoreBtn.removeClass("ui-dialog-titlebar-restore").addClass("ui-dialog-titlebar-minimize");sessionStorage.setItem("motopressDialogState",this.state.restored);this.element.nextAll().add(this.element).removeClass("motopress-hide");this.dialog.removeClass("motopress-dialog-"+
this.state.minimized).addClass("motopress-dialog-"+this.state.restored);this.element.dialog("option","height",400);this.element.dialog({position:{my:"center",at:"center",of:window}});sessionStorage.setItem("motopressDialogLeft",this.dialog.css("left"));sessionStorage.setItem("motopressDialogTop",this.dialog.css("top"));this.element.dialog("option","draggable",!0)}})}(jQuery),function(c){CE.WPMedia=can.Construct({myThis:null},{frame:null,propertyMedia:null,init:function(){CE.WPMedia.myThis=this;this.frame=
parent.wp.media({id:"motopress-media-library",multiple:!1,describe:!1,toolbar:"select",sidebar:"settings",content:"upload",router:"browse",menu:"default",searchable:!0,filterable:!1,sortable:!1,title:localStorage.getItem("CEMediaLibraryText"),button:{text:localStorage.getItem("CEMediaLibraryText")},contentUserSetting:!0,syncSelection:!0});this.frame.on("open",this.proxy("onOpen"));this.frame.on("select",this.proxy("setMedia"));this.frame.on("close",this.proxy("onClose"))},onOpen:function(){var a;
this.propertyMedia=CE.Dialog.myThis.element.find("[data-motopress-open-media-lib=1]");this.propertyMediaID=this.propertyMedia.find(".motopress-property-media-id");this.propertyMediaSrc=this.propertyMedia.find(".motopress-property-media");a=this.propertyMediaID.val();a=null!==a?parent.wp.media.attachment(a):parent.wp.media.attachment();a.fetch();this.frame.state().get("selection").add(a)},setMedia:function(){var a=this.frame.state().get("selection").models[0].attributes,b=this.propertyMedia.control(),
c=a.url;this.propertyMediaID.val(a.id);this.propertyMediaSrc.val(c);b.element.removeAttr("data-motopress-open-media-lib");b.element.trigger("change")},onClose:function(){c("."+CE.Dialog.myThis.dialogClass).focus();this.propertyMedia.removeAttr("data-motopress-open-media-lib");var a=c(parent.document).find("html, body");a.addClass("motopress-ce-jumping-fix");var b=setTimeout(function(){a.removeClass("motopress-ce-jumping-fix");clearTimeout(b)},0)}});CE.WPAudio=can.Construct({myThis:null},{frame:null,
propertyAudio:null,propertyAudioTitle:null,init:function(){CE.WPAudio.myThis=this;this.frame=parent.wp.media({id:"motopress-audio-library",multiple:!1,describe:!1,toolbar:"select",sidebar:"settings",content:"upload",router:"browse",menu:"default",searchable:!0,filterable:!1,sortable:!1,title:"Set audio file",button:{text:"Set audio file"},library:{type:"audio"},contentUserSetting:!0,syncSelection:!0});this.frame.on("open",this.proxy("onOpen"));this.frame.on("select",this.proxy("setAudio"));this.frame.on("close",
...
this.propertyAudio.trigger("change")},onClose:function(){c("."+CE.Dialog.myThis.dialogClass).focus();var a=c(parent.document).find("html, body");a.addClass("motopress-ce-jumping-fix");var b=setTimeout(function(){a.removeClass("motopress-ce-jumping-fix");clearTimeout(b)},0)}});CE.WPVideo=can.Construct({myThis:null},{frame:null,propertyVideo:null,init:function(){CE.WPVideo.myThis=this;this.frame=parent.wp.media({id:"motopress-video-library",multiple:!1,describe:!1,toolbar:"select",sidebar:"settings",
...
this.frame.state().get("selection").models[0].attributes.url,b=this.propertyVideo.control();b.set(a);b.element.removeAttr("data-motopress-open-video-lib");b.element.trigger("change")},onClose:function(){c("."+CE.Dialog.myThis.dialogClass).focus();this.propertyVideo.removeAttr("data-motopress-open-video-lib");var a=c(parent.document).find("html, body");a.addClass("motopress-ce-jumping-fix");var b=setTimeout(function(){a.removeClass("motopress-ce-jumping-fix");clearTimeout(b)},0)}})}(jQuery),function(c){CE.Style=
can.Construct({gridProps:null,props:{mp_custom_style:{type:"style_editor",label:localStorage.getItem("CECustomStyle"),description:localStorage.getItem("CECustomStyleDesc"),parameters:{"background-color":{type:"color-picker",label:localStorage.getItem("CEBgColor"),"default":""},color:{type:"color-picker",label:"Text Color","default":""},"background-image-type":{type:"radio-buttons",label:"Background Type","default":"image",list:{image:"Image",gradient:"Gradient",none:"None"}},"background-image":{type:"image-src",
label:localStorage.getItem("CEBgImage"),"default":"",dependency:{parameter:"background-image-type",value:"image"}},"background-repeat":{type:"select",label:localStorage.getItem("CEBgImageRepeat"),"default":"",list:{"":localStorage.getItem("CEDefault"),repeat:localStorage.getItem("CERepeat"),"repeat-x":localStorage.getItem("CERepeatX"),"repeat-y":localStorage.getItem("CERepeatY"),"no-repeat":localStorage.getItem("CENoRepeat")},dependency:{parameter:"background-image",except:""}},"background-size":{type:"select",
label:localStorage.getItem("CEBgImageSize"),"default":"",list:{"":localStorage.getItem("CEDefault"),cover:localStorage.getItem("CECover"),contain:localStorage.getItem("CEContain"),auto:localStorage.getItem("CEAuto")},dependency:{parameter:"background-image",except:""}},"background-position":{type:"select",label:localStorage.getItem("CEBgImagePosition"),"default":"",list:{"":localStorage.getItem("CEDefault"),"center center":localStorage.getItem("CECenter")+" "+localStorage.getItem("CEMiddle"),"center top":localStorage.getItem("CECenter")+
" "+localStorage.getItem("CETop"),"center bottom":localStorage.getItem("CECenter")+" "+localStorage.getItem("CEBottom"),"left top":localStorage.getItem("CELeft")+" "+localStorage.getItem("CETop"),"left center":localStorage.getItem("CELeft")+" "+localStorage.getItem("CEMiddle"),"left bottom":localStorage.getItem("CELeft")+" "+localStorage.getItem("CEBottom"),"right top":localStorage.getItem("CERight")+" "+localStorage.getItem("CETop"),"right center":localStorage.getItem("CERight")+" "+localStorage.getItem("CECenter"),
"right bottom":localStorage.getItem("CERight")+" "+localStorage.getItem("CEBottom"),custom:localStorage.getItem("CECustom")},dependency:{parameter:"background-image",except:""}},"background-position-x":{type:"spinner",label:localStorage.getItem("CEBgImagePositionX"),min:0,max:100,step:1,"default":"50",dependency:{parameter:"background-position",value:"custom"}},"background-position-y":{type:"spinner",label:localStorage.getItem("CEBgImagePositionY"),min:0,max:100,step:1,"default":"50",dependency:{parameter:"background-position",
value:"custom"}},"background-attachment":{type:"select",label:localStorage.getItem("CEBgImageAttachment"),"default":"",list:{"":localStorage.getItem("CEDefault"),fixed:localStorage.getItem("CEFixed"),scroll:localStorage.getItem("CEScroll")},dependency:{parameter:"background-image",except:""}},"background-gradient":{type:"gradient-picker",label:"","default":"",dependency:{parameter:"background-image-type",value:"gradient",needDependenceValue:!0}},"padding-top":{type:"text",label:localStorage.getItem("CEPaddingTop"),
"default":""},"padding-bottom":{type:"text",label:localStorage.getItem("CEPaddingBottom"),"default":""},"padding-left":{type:"text",label:localStorage.getItem("CEPaddingLeft"),"default":""},"padding-right":{type:"text",label:localStorage.getItem("CEPaddingRight"),"default":""},"margin-top":{type:"text",label:localStorage.getItem("CEMarginTop"),"default":""},"margin-bottom":{type:"text",label:localStorage.getItem("CEMarginBottom"),"default":""},"margin-left":{type:"text",label:localStorage.getItem("CEMarginLeft"),
"default":""},"margin-right":{type:"text",label:localStorage.getItem("CEMarginRight"),"default":""},"border-style":{type:"select",label:localStorage.getItem("CEBorderStyle"),"default":"",list:{"":localStorage.getItem("CEDefault"),none:localStorage.getItem("CENone"),solid:localStorage.getItem("CESolid"),dotted:localStorage.getItem("CEDotted"),dashed:localStorage.getItem("CEDashed"),"double":localStorage.getItem("CEDouble"),grouve:localStorage.getItem("CEGrouve"),ridge:localStorage.getItem("CERidge"),
inset:localStorage.getItem("CEInset"),outset:localStorage.getItem("CEOutset")}},"border-top-width":{type:"text",label:localStorage.getItem("CEBorderWidthTop"),"default":"",dependency:{parameter:"border-style",except:"none"}},"border-bottom-width":{type:"text",label:localStorage.getItem("CEBorderWidthBottom"),"default":"",dependency:{parameter:"border-style",except:"none"}},"border-left-width":{type:"text",label:localStorage.getItem("CEBorderWidthLeft"),"default":"",dependency:{parameter:"border-style",
except:"none"}},"border-right-width":{type:"text",label:localStorage.getItem("CEBorderWidthRight"),"default":"",dependency:{parameter:"border-style",except:"none"}},"border-color":{type:"color-picker",label:localStorage.getItem("CEBorderColor"),"default":"",dependency:{parameter:"border-style",except:"none"}},"border-top-left-radius":{type:"text",label:localStorage.getItem("CEBorderRadiusTopLeft"),"default":""},"border-top-right-radius":{type:"text",label:localStorage.getItem("CEBorderRadiusTopRight"),
"default":""},"border-bottom-left-radius":{type:"text",label:localStorage.getItem("CEBorderRadiusBottomLeft"),"default":""},"border-bottom-right-radius":{type:"text",label:localStorage.getItem("CEBorderRadiusBottomRight"),"default":""}}},mp_style_classes:{type:"select2",label:localStorage.getItem("CEStyleClassesLabel"),description:localStorage.getItem("CEStyleClassesLabelDesc")},margin:{type:"margin",label:localStorage.getItem("CEMarginLabel"),sides:["top","bottom","left","right"],values:["none",
0,10,15,20,25,50,100],"default":["none","none","none","none"],classPrefix:"motopress-margin-",regExp:""}},getStyleEditorProps:function(){return c.extend({},CE.Style.props.mp_custom_style.parameters)},globalPredefinedClasses:{}},{})}(jQuery),function(c){CE.Ctrl=can.Control.extend({bodyEl:c("body"),processValue:function(a,b,c){(a="undefined"!==typeof c&&c&&"undefined"===typeof a?b:a)||(a="");return String(a)}},{name:null,dependency:!1,disabled:!1,hided:!1,isPermanentHided:!1,customized:!1,shortcode:null,
shortcodeName:null,shortcodeCtrl:null,formCtrl:null,init:function(a,b){this.customized=!1;this.name=b.name;this.dependency=b.dependency;this.disabled=b.disabled;this.isPermanentHided=b.hasOwnProperty("isPermanentHided")&&b.isPermanentHided;this.formCtrl=b.formCtrl;b.hasOwnProperty("innerForm")&&(this.innerForm=b.innerForm);this.shortcode=b.shortcode;this.shortcodeName=CE.Shortcode.getShortcodeName(this.shortcode);this.shortcodeGroup=CE.Shortcode.getShortcodeGroup(this.shortcode);this.shortcodeCtrl=
b.shortcode.control()},afterInit:function(){this.isPermanentHided&&this.hide()},get:function(){},set:function(){},hide:function(){this.element.closest("[data-motopress-parameter]").addClass("motopress-hide");this.hided=!0},show:function(){this.isPermanentHided||(this.element.closest("[data-motopress-parameter]").removeClass("motopress-hide"),this.hided=!1)},isHided:function(){return this.hided},change:function(a,b,c){b.stopPropagation();"undefined"===typeof c&&(c=!0);this.hideDependencedControls();
c&&this.formCtrl.changeProperty(this)}," customize":function(a,b){if(this.customized)return!1;this.customized=!0},hideDependencedControls:function(){var a=this,b;a.formCtrl.form.find('> [data-motopress-parameter] > .motopress-controls:not(".select2-container"), > [data-motopress-parameter] > :not(".motopress-property-legend, .motopress-property-label, .motopress-property-description, hr") > .motopress-controls').each(function(){b=c(this).control();b.dependency&&a.name===b.dependency.parameter&&(b.isShouldBeHiddenByDependency()?
...
b.get()==this.dependency.except:!1;!d||e?a=!0:b.dependency&&(a=b.isShouldBeHiddenByDependency())}return a}});CE.Ctrl("CE.CtrlInput",{},{get:function(){return this.element.val()},set:function(a,b,c){a=CE.Ctrl.processValue(a,b,c);this.element.val(a)}});CE.Ctrl("CE.CtrlSpinner",{listensTo:["customize"]},{spinning:!1,min:null,max:null,step:1,init:function(a,b){this._super(a,b);b.hasOwnProperty("min")&&(this.min=b.min);b.hasOwnProperty("max")&&(this.max=b.max);b.hasOwnProperty("step")&&(this.step=b.step)},
" customize":function(a,b){if(this.customized)return!1;this.customized=!0;var c=this;a.spinner({disabled:this.disabled,min:this.min,max:this.max,step:this.step,stop:function(b,f){c.spinning&&(a.trigger("change",c.oldValue),c.spinning=!1,c.oldValue=null)},spin:function(a,b){c.spinning||(c.spinning=!0,c.oldValue=c.get())}})},change:function(a,b,c){var e=this.get();null!==e&&c!==e&&e>=this.min&&e<=this.max&&0===(e/this.step).toFixed(12)%1&&CE.Ctrl.prototype.change.apply(this,[a,b])},get:function(){return this.element.spinner("value")},
...
init:function(){CE.InlineEditorImageLibrary.myThis=this;this.frame=new parent.wp.media.view.MediaFrame.Post({id:"motopress-inline-editor-image-library",multiple:!1,library:{type:"image",search:null},contentUserSetting:!0,syncSelection:!0});this.frame.on("attach",function(){parent.jQuery("#motopress-inline-editor-image-library").addClass("hide-menu")})},open:function(){this.frame.open()},onSelect:function(a){this.frame.on("insert",this.proxy(function(){var b=this.frame.state(),c=b.get("selection").models[0],
b=b.display(c).toJSON(),c=parent.wp.media.editor.send.attachment(b,c.toJSON());a(c)}))}})}(jQuery),function(c){CE.Controls("CE.InlineEditor",{media:null,curElement:null,styleFormats:!1,init:function(){CE.InlineEditor.media=new CE.InlineEditorImageLibrary;CE.InlineEditor.media.onSelect(function(a){var b=CE.InlineEditor.curElement.control().editor;a.done(function(a){b.insertContent(a);setTimeout(function(){c(b.getElement()).closest(".motopress-clmn").find("."+CE.DragDrop.myThis.helper.attr("class")).first().children("."+
CE.DragDrop.myThis.dragHandle.attr("class")).click();b.focus();b.selection.select(b.getBody(),!0);b.selection.collapse(!1)},200)})});c(document).on("mousedown",".mce-tinymce.mce-panel",function(a){a.preventDefault()});c(document).on("keydown",'[data-motopress-shortcode="mp_text"], [data-motopress-shortcode="mp_heading"]',function(a){a.which===c.ui.keyCode.TAB?CE.Selectable.myThis.unselect():a.which===c.ui.keyCode.ESCAPE&&(CE.InlineEditor.curElement&&CE.InlineEditor.curElement.control().close(!0,"show"),
a=c(this).closest(".motopress-clmn").find("."+CE.DragDrop.myThis.helper.attr("class")).first().children("."+CE.DragDrop.myThis.dragHandle.attr("class")),CE.Selectable.focusWithoutScroll(CE.Selectable.getFocusAreaBySelected(a)),CE.Dialog.myThis.element.dialog("isOpen")||CE.Dialog.myThis.open(a))});c(parent.document).on("mousedown",function(a){CE.InlineEditor.curElement&&!c(a.target).closest(".ui-dialog").length&&CE.InlineEditor.curElement.control().close(!0,"show")})},isTinymce:function(a){var b=!1;
c(a.target).hasClass("motopress-drag-handle")||(a=c(a.currentTarget.activeElement),a.length&&(a.closest("[data-motopress-shortcode]").length||a.closest(".mce-tinymce").length||a.closest(".mce-window").length||a.closest(".mce-popover").length)&&(b=!0));return b},destroyAll:function(){var a;parent.CE.Iframe.myThis.sceneContent.find('[data-motopress-shortcode="mp_text"], [data-motopress-shortcode="mp_heading"]').each(function(){a=c(this).control();a.destroyEditor()})},reinitAll:function(){var a;parent.CE.Iframe.myThis.sceneContent.find('[data-motopress-shortcode="mp_text"], [data-motopress-shortcode="mp_heading"]').each(function(){a=
c(this).control();a.initEditor()})}},{id:null,isOpen:!1,editor:null,helpers:null,blockContent:null,floatpanel:null,saved:!1,init:function(a,b){this._super(a,b);this.id=parent.MP.Utils.uniqid();this.blockContent=this.element.parent("."+CE.DragDrop.myThis.blockContent.attr("class"));var c=this.element.closest(".motopress-clmn").find("."+CE.DragDrop.myThis.helper.attr("class")).first();this.helpers=c.add(c.children().not(".motopress-splitter, .motopress-clmn-select-handle"));this.resizers=this.blockContent.nextAll(".ui-resizable-handle");
c.children("."+CE.DragDrop.myThis.dragHandle.attr("class")).on("click",this.proxy("onClick"))},destroy:function(){CE.InlineEditor.curElement=null;this.floatpanel&&this.floatpanel.remove();this._super()},initEditor:function(){var a=this,b=this.element.closest(".motopress-clmn").find("."+CE.DragDrop.myThis.helper.attr("class")).first().children("."+CE.DragDrop.myThis.dragHandle.attr("class")),d=setTimeout(function(){var e;e=" mpce_image wp_img_edit | ";e+="bold italic underline | ";c.isEmptyObject(CE.InlineEditor.styleFormats)||
(e+="styleselect | ");e+="formatselect | fontsizeselect forecolor | alignleft aligncenter alignright | numlist bullist outdent indent | link unlink blockquote hr removeformat";tinyMCE.PluginManager.add("wordpress",parent.tinyMCE.AddOnManager.PluginManager.get("wordpress"));tinyMCE.PluginManager.add("wpeditimage",parent.tinyMCE.AddOnManager.PluginManager.get("wpeditimage"));tinyMCE.init({selector:"#"+a.id,inline:!0,plugins:"link hr textcolor lists wordpress wpeditimage image",visual:!1,convert_urls:!1,
menubar:!1,toolbar:e,block_formats:"Paragraph=p;Header 1=h1;Header 2=h2;Header 3=h3;Header 4=h4;Header 5=h5;Header 6=h6;Address=address;Pre=pre;",fontsize_formats:"8px 9px 10px 11px 12px 13px 14px 15px 16px 18px 24px 30px 36px 42px 48px 60px 72px 96px",language:parent.MP.Settings.lang.tinymce,skin:"motopresscontenteditor",browser_spellcheck:parent.MP.Settings.spellcheck,style_formats_merge:!1,style_formats:CE.InlineEditor.styleFormats,setup:function(d){a.editor=d;d.on("loadContent",function(){a.autoOpen(b,
...
a.floatpanel.width()>c(window).width()&&(b=a.element.offset().left+a.element.width()-a.floatpanel.width(),a.floatpanel.css("left",b))}});d.addButton("mpce_image",{icon:"image",tooltip:localStorage.getItem("CEInsertEditImage"),stateSelector:"img:not([data-mce-object],[data-mce-placeholder]),figure.image",onclick:function(a){this.active()?this.$el.next().trigger("click"):CE.InlineEditor.media.open()},onpostrender:function(){this.$el.next().hide()}})},init_instance_callback:function(d){c.each(d.menuItems.formats.menu,
function(a,b){"Blocks"===b.text&&c.each(b.menu,function(a,c){"Div"===c.text&&delete b.menu[a]})});c(d.getBody()).on("blur",function(){a.save()});c(d.getBody()).on("focus",function(){a.saved=!1;if(b.hasClass(CE.Selectable.myThis.selectedClass))b.trigger("click");else var c=setTimeout(function(){CE.LeftBar.myThis.leftBar.focus();clearTimeout(c)},0)})}});clearTimeout(d)},0)},destroyEditor:function(){this.editor.destroy();this.editor=null}," render":function(){this.shortcode.children("div").attr("id",
this.id);this.initEditor()},onClick:function(a){c(a.target).hasClass(CE.Selectable.myThis.selectedClass)&&!this.isOpen&&(this.isOpen=!0,CE.InlineEditor.curElement=this.element,CE.Dialog.myThis.element.dialog("isOpen")&&CE.Dialog.myThis.element.dialog("close"),this.helpers.hide(),c(".motopress-content-wrapper > .motopress-handle-middle-in:last").height(""),this.resizers.hide(),this.blockContent.addClass("motopress-overflow-visible-important"),this.editor.execCommand("mceToggleEditor",!1),this.showHideFloatpanel("show"))},
...
CE.Resizer.myThis.updateSplitterHeight(this.element,"split"),CE.Resizer.myThis.updateHandleMiddle())},autoOpen:function(a,b){if(3>=b)if(1<b&&a.hasClass(CE.Selectable.myThis.selectedClass))CE.Dialog.myThis.element.dialog("isOpen")&&CE.Dialog.myThis.element.dialog("close"),c(this.editor.getBody()).trigger("blur").trigger("focus"),a.trigger("click");else var d=this,e=setTimeout(function(){d.autoOpen(a,b+1);clearTimeout(e)},500)},showHideFloatpanel:function(a){this.floatpanel&&("show"===a?this.floatpanel.show():
this.floatpanel.hide())}})}(jQuery),function(c){CE.Controls("CE.CodeEditor",{},{init:function(a,b){this._super(a,b);var c=this.element.closest(".motopress-clmn").find("."+CE.DragDrop.myThis.helper.attr("class")).first().children("."+CE.DragDrop.myThis.dragHandle.attr("class"));this.autoOpen(c,1);c.on("click",this.proxy("onClick"))},destroy:function(){this._super()}," render":function(){this.shortcode.find(".row").removeClass("row").addClass(parent.CE.Iframe.myThis.gridObj.row["class"]);this.shortcode.find("a").attr("tabindex",
-1);CE.Resizer.myThis.updateAllHandles()},autoOpen:function(a,b){if(3>=b)if(1<b&&a.hasClass(CE.Selectable.myThis.selectedClass))a.trigger("click");else var c=this,e=setTimeout(function(){c.autoOpen(a,b+1);clearTimeout(e)},500)},onClick:function(a){if(c(a.target).hasClass(CE.Selectable.myThis.selectedClass)){a=parent.CE.CodeModal.myThis.editor;parent.CE.CodeModal.currentShortcode=this.element;var b=this.shortcode.attr("data-motopress-content");"undefined"!==typeof b&&(b=b.replace(RegExp("\\[\\]","ig"),
"["),null!==a&&a.setContent(b,{format:"html"}),parent.CE.CodeModal.myThis.content.val(parent.switchEditors._wp_Nop(b)));parent.CE.CodeModal.myThis.saveHandler=this.saveHandler;parent.CE.CodeModal.myThis.element.mpmodal("show")}},saveHandler:function(a){a=parent.CE.CodeModal.myThis;a.switchVisual();var b=parent.CE.CodeModal.currentShortcode.control(),c=null!==a.editor?a.editor.getContent({format:"html"}):parent.switchEditors._wp_Autop(a.content.val());c.length?b.shortcode.attr("data-motopress-content",
c):b.shortcode.removeAttr("data-motopress-content");b.renderShortcode();a.element.mpmodal("hide")}})}(jQuery),function(c){CE.Tools=can.Construct({myThis:null},{init:function(){CE.Tools.myThis=this},removeBlock:function(){CE.Utils.removeSceneAction("select");var a=c(".motopress-selected"),b=parent.MP.Utils.getEntityTypeBySelected(a);CE.Selectable.setScrollY(window.scrollY);CE.Dialog.myThis.element.dialog("isOpen")&&CE.Dialog.myThis.element.dialog("close");parent.CE.Navbar.myThis.hideObjectControlBtns();
var d=a,e,f,g,l,h,m=null,k=!1,q;b.is_row?(f=a,e=a.closest(".motopress-clmn"),m=e.closest(".motopress-clmn").siblings(".motopress-clmn"),g=a.parents(".motopress-row").first(),g.closest(".motopress-content-wrapper").length||(g=null),q=a.siblings(".motopress-row").length,e.length&&!q&&(h=parent.MP.Utils.getSpanClass(e.prop("class").split(" ")),CE.DragDrop.myThis.removeEmptyBlocks(e,h))):(b.is_clmn?e=a:(e=a.closest(".motopress-clmn"),d=e.find(".motopress-block-content > [data-motopress-shortcode]").first()),
f=e.closest(".motopress-row"),l=parent.MP.Utils.getEdgeRow(f),m=e.siblings(".motopress-clmn"),h=parent.MP.Utils.getSpanClass(e.prop("class").split(" ")),CE.DragDrop.myThis.removeEmptyBlocks(e,h),l=l.children(".motopress-clmn").index(e),l=CE.DragDrop.myThis.canBeMoved(f,null,l));d.find("[data-motopress-shortcode].ce_inline_editor").addBack().filter(".ce_inline_editor").each(function(){var a=c(this).control().child.attr("id");"undefined"!==typeof a&&(a=tinymce.get(a),"undefined"!==typeof a&&a.destroy())});
b.is_row?a.children().remove():e.remove();(a=CE.DragDrop.myThis.clearIfEmpty(f,"remove"))&&a.hasOwnProperty("row")&&(k=!0,f=a.row);CE.DragDrop.myThis.isEmptyScene()&&(c(".motopress-handle-middle-in").remove(),CE.DragDrop.myThis.emptySceneHelper.show(),CE.Utils.addSceneState("empty-scene"));b.is_row?null===g||q||CE.DragDrop.myThis.resize(g,e,"remove",!0):(k||CE.DragDrop.myThis.resize(f,e,"remove",l),CE.Resizer.myThis.updateSplittableOptions(null,f,null));CE.Resizer.myThis.updateAllHandles();c(window).trigger("resize");
var n,p={involvedElements:{}};null!==m&&m.length&&m.find(".motopress-block-content > [data-motopress-shortcode]").each(function(){c(this).length&&(n=c(this).attr("data-motopress-shortcode"),p.involvedElements.hasOwnProperty(n)||(p.involvedElements[n]=[]),p.involvedElements[n].push(this))});c("body").trigger("MPCEObjectRemove",p)}})}(jQuery),function(c){CE.Resizer=can.Construct({myThis:null},{minHeight:30,minWidth:8,spaceMinHeight:10,gmapMinHeight:150,handle:null,addedStyleProperties:"position top left width height background-position background-repeat".split(" "),
...
zIndex:1002,create:function(){c(this).resizable("option","maxWidth",parseFloat(c(this).css("width")));c(this).children(".ui-resizable-handle").hide();var a=CE.Grid.myThis.padding-4;c(this).children(".ui-resizable-e, .ui-resizable-se").css("right",a);c(this).children(".ui-resizable-w, .ui-resizable-sw").css("left",a)},start:function(g,h){CE.Utils.addSceneAction("resize");CE.LeftBar.myThis.disable();b.hideSplitters();b.hideEmptySpans();c(".motopress-content-wrapper > .motopress-handle-middle-in:last").height("");
...
var b=this,d,e,f;(a.hasClass("motopress-splitter")?a:a.find(".motopress-splitter")).draggable({axis:"x",cursor:"col-resize",grid:[1,0],helper:"clone",zIndex:1,start:function(a,e){CE.Utils.addSceneAction("split");e.helper.hide();b.hideSplitters(c(this));b.hideEmptySpans();c(".motopress-content-wrapper > .motopress-handle-middle-in:last").height("");d=null;f=!1;CE.LeftBar.myThis.disable();c(this).addClass("motopress-splitter-hover");CE.Dialog.myThis.element.dialog("isOpen")&&CE.Dialog.myThis.element.dialog("close");
var h=e.helper.closest(".motopress-row");h.find(".motopress-drag-handle").css("cursor","col-resize");var m=parent.MP.Utils.getEdgeRow(h).width()/100,k=c(this).closest(".motopress-clmn"),h=k.prev(".motopress-clmn"),q=parent.MP.Utils.getSpanNumber(parent.MP.Utils.getSpanClass(k.prop("class").split(" "))),n=parent.MP.Utils.getSpanNumber(parent.MP.Utils.getSpanClass(h.prop("class").split(" "))),p=h.offset().left;if(h.is("[data-motopress-wrapper-id]"))var r=b.getMinChildColumn(h);if(k.is("[data-motopress-wrapper-id]"))var t=
b.getMinChildColumn(k);for(var u=q+n-1,v=[],s=1;s<=u;s++)v[s]=m*CE.Grid.myThis.colWidthByNumber[s];for(var m=v.slice(),x,s=1;s<n;s++)0>v[s]-2*CE.Grid.myThis.padding?v[s]=-1*(p+v[s]):(x=1,u=Math.abs(v[s]),0<v[s]&&h.is("[data-motopress-wrapper-id]")&&(b.isAllowedColSize(r,u)||(x=-1)),v[s]=(p+v[s])*x);r=n-1;for(s=q;1<=s;s--)r++,0>m[s]-2*CE.Grid.myThis.padding?v[r]=-1*(p+v[r]):(x=1,u=m[s],0<m[s]&&k.is("[data-motopress-wrapper-id]")&&(b.isAllowedColSize(t,u)||(x=-1)),v[r]=(p+v[r])*x);c(this).data("mp-snap-grid",
v);b.currentI=n;b.curSplitterArea="";var y,z={involvedElements:{}};k.length&&(t=k.find(".motopress-block-content > [data-motopress-shortcode]"),t.length&&t.each(function(){y=c(this).attr("data-motopress-shortcode");z.involvedElements.hasOwnProperty(y)||(z.involvedElements[y]=[]);z.involvedElements[y].push(this)}));h.length&&(t=h.find(".motopress-block-content > [data-motopress-shortcode]"),t.length&&t.each(function(){y=c(this).attr("data-motopress-shortcode");z.involvedElements.hasOwnProperty(y)||
(z.involvedElements[y]=[]);z.involvedElements[y].push(this)}));c("body").trigger("MPCEObjectSplitStart",z)},stop:function(a,d){CE.Utils.removeSceneAction("split");CE.LeftBar.myThis.enable();b.showSplitters();b.showEmptySpans();d.helper.closest(".motopress-row").find(".motopress-drag-handle").css("cursor","move");c(this).removeClass("motopress-splitter-hover");var h=c(this).closest(".motopress-clmn"),m=h.prev(".motopress-clmn");CE.Resizer.myThis.updateSplittableOptions(h,null,null,"split");CE.Resizer.myThis.updateAllHandles();
f&&e.length&&e.remove();parent.CE.Save.changeContent();var k,q={involvedElements:{}};h.length&&(h=h.find(".motopress-block-content > [data-motopress-shortcode]"),h.length&&h.each(function(){k=c(this).attr("data-motopress-shortcode");q.involvedElements.hasOwnProperty(k)||(q.involvedElements[k]=[]);q.involvedElements[k].push(this)}));m.length&&(h=m.find(".motopress-block-content > [data-motopress-shortcode]"),h.length&&h.each(function(){k=c(this).attr("data-motopress-shortcode");q.involvedElements.hasOwnProperty(k)||
(q.involvedElements[k]=[]);q.involvedElements[k].push(this)}));c("body").trigger("MPCEObjectSplitStop",q)},drag:function(a,l){var h=!1,m=l.offset.left-CE.Grid.myThis.padding/2;null===d&&(d=m);if(m!==d){var k=c(this).closest(".motopress-clmn"),q=null,n=k.closest(".motopress-row-edge").width(),p,r,t=c(this).data("mp-snap-grid"),u=t.length-1,v=CE.LeftBar.myThis.getSpace();1<u?(p=Math.abs(t[2])-Math.abs(t[1]),r=Math.abs(t[u])-Math.abs(t[u-1])):p=r=n/100*CE.Grid.myThis.colWidthByNumber[1];p>CE.Grid.myThis.padding&&
(p-=CE.Grid.myThis.padding);p>CE.Grid.myThis.padding&&(p-=CE.Grid.myThis.padding);r>CE.Grid.myThis.padding&&(r-=CE.Grid.myThis.padding);p=a.pageX<=v+2||m<=Math.abs(t[1])-p;r=a.pageX>=c(document).width()-2||m>=Math.abs(t[u])+1.5*r;if(p||r){if(p&&"left"===b.curSplitterArea||r&&"right"===b.curSplitterArea)return;q=k.prev(".motopress-clmn");m=parent.MP.Utils.getSpanClass(k.prop("class").split(" "));n=parent.MP.Utils.getSpanClass(q.prop("class").split(" "));m=parent.MP.Utils.getSpanNumber(m);n=parent.MP.Utils.getSpanNumber(n);
...
k.hasClass("motopress-empty"))CE.Resizer.myThis.changeSpanClass(q,parent.CE.Iframe.myThis.gridObj.span["class"]+(n+m)),e=k,f=!0,c(window).trigger("resize"),h=!0;else{m=0;for(p=u;1<=p;p--)if(0<t[p]){m=p;break}m&&(CE.Resizer.myThis.changeSpanClass(k,parent.CE.Iframe.myThis.gridObj.span["class"]+(u+1-m)),CE.Resizer.myThis.changeSpanClass(q,parent.CE.Iframe.myThis.gridObj.span["class"]+m),b.currentI=m,c(window).trigger("resize"),h=!0)}}else for(b.curSplitterArea="center",v=m<d?-1:1,r=!1,p=1;p<=u;p++)if(!(0>=
...
setEdgeSpan:function(a,b,d){d="undefined"!==typeof d&&d;var e="undefined"!==typeof b&&b?".motopress-filler-content":"[data-motopress-shortcode]",f,g;c.each(a,function(){f=c(this).find(e).first();g=f.parent();g.hasClass("motopress-block-content")||(g.addClass("motopress-clmn-edge"),d&&f.remove())})}},{inited:!1,blockContent:c("<div />",{"class":"motopress-block-content"}),handleTopIn:c("<div />",{"class":"motopress-handle-top-in","data-motopress-position":"top-in"}),handleBottomIn:c("<div />",{"class":"motopress-handle-bottom-in",
"data-motopress-position":"bottom-in"}),handleIntermediate:c("<div />",{"class":"motopress-handle-intermediate","data-motopress-position":"intermediate"}),handleLeftOut:c("<div />",{"class":"motopress-handle-left-out","data-motopress-position":"left-out"}),handleRightOut:c("<div />",{"class":"motopress-handle-right-out","data-motopress-position":"right-out"}),handleLeftIn:c("<div />",{"class":"motopress-handle-left-in","data-motopress-position":"left-in"}),handleRightIn:c("<div />",{"class":"motopress-handle-right-in",
"data-motopress-position":"right-in"}),handleLeft:c("<div />",{"class":"motopress-outer-handle motopress-handle-left motopress-outer-handle-hidden","data-motopress-position":"left"}),handleRight:c("<div />",{"class":"motopress-outer-handle motopress-handle-right motopress-outer-handle-hidden","data-motopress-position":"right"}),overlay:c("<div />",{"class":"motopress-overlay"}),dragHandle:c("<div />",{"class":"motopress-drag-handle"}),focusArea:c("<div />",{"class":"motopress-focus-area",tabindex:-1}),
helper:c("<section />",{"class":"motopress-helper"}),handleMiddleOut:c("<span />",{"class":"motopress-handle-middle-out","data-motopress-position":"middle-out"}),handleMiddleIn:c("<span />",{"class":"motopress-outer-handle motopress-handle-middle-in motopress-outer-handle-hidden","data-motopress-position":"middle-in"}),emptySceneHelper:c("<section />",{id:"motopress-empty-scene-helper"}),emptySceneDroppable:c("<div />",{"class":"motopress-empty-scene",html:'<div class="motopress-empty-scene-container-first"><div class="motopress-empty-scene-image"></div><div class="motopress-empty-scene-wrapper-right"><div class="motopress-empty-scene-title">'+
...
this.handleRightIn,this.handleRight.clone());this.helper.append(this.overlay,this.focusArea.clone(),this.dragHandle.clone(),this.resizer.splitter.clone());this.emptySpanOverlay.append(this.handleIntermediate.clone(),this.handleLeft.clone(),this.handleRight.clone(),this.handleInsert.clone());this.emptySpanHelper.append(this.emptySpanOverlay,this.resizer.splitter.clone());this.wrapperHelper.append(this.handleIntermediate.clone(),this.handleLeft.clone(),this.handleRight.clone());this.wrapperHelperResizer.append(this.focusArea.clone(),
this.resizer.splitter.clone());var a=setTimeout(function(){CE.DragDrop.myThis.textHelperHalfSize=Math.round(CE.DragDrop.myThis.textHelperHandleMiddle.height()/2);CE.DragDrop.myThis.lineHelperThickness=CE.DragDrop.myThis.lineHelperLeftIn.outerWidth();CE.DragDrop.myThis.lineHelperHalfThickness=Math.round(CE.DragDrop.myThis.lineHelperHandleMiddle.height()/2);CE.DragDrop.myThis.handleMiddleHalfThickness=Math.round(3);clearTimeout(a)},0);this.emptySceneHelper.append(this.emptySceneDroppable,this.templates).appendTo(c(".motopress-content-wrapper"));
...
!0);CE.Resizer.myThis.changeSpanClass(this.spanHtml,"");this.spanInnerHtml=c(parent.motopressCE.rendered_shortcodes.grid[parent.CE.Iframe.myThis.gridObj.span.inner]);CE.DragDrop.setEdgeSpan(this.spanInnerHtml,!0);CE.Resizer.myThis.changeSpanClass(this.spanInnerHtml,"");this.rowHtml=c(parent.motopressCE.rendered_shortcodes.grid[parent.CE.Iframe.myThis.gridObj.row.shortcode]);this.rowInnerHtml=c(parent.motopressCE.rendered_shortcodes.grid[parent.CE.Iframe.myThis.gridObj.row.inner])},main:function(a){a=
void 0!==a?a:c(".motopress-content-wrapper");this.inited||this.sceneEvents();var b=c(".motopress-content-wrapper .motopress-row").not('.motopress-content-wrapper [data-motopress-group]:not([data-motopress-group="mp_grid"]) .motopress-row');a=a.hasClass("motopress-clmn")?a.find(".motopress-clmn").addBack():a.find(".motopress-clmn");a=a.not('.motopress-content-wrapper [data-motopress-group]:not([data-motopress-group="mp_grid"]) .motopress-clmn');this.inited||this.addEmptySceneHelper();this.inited||
this.addHandleMoreDisable();this.recursiveAddHandleMiddle(c(".motopress-content-wrapper"));this.makeEditable(a.not(".motopress-empty"));this.makeRowEditable(b);this.makeEditableEmptySpan(a.filter(".motopress-empty"));this.resizer.updateSplittableOptions(null,null,null,"init");this.resizer.updateAllHandles();this.isEmptyScene()&&CE.Utils.addSceneState("empty-scene");this.inited=!0},isEmptyScene:function(){return!c(".motopress-content-wrapper>.motopress-row").length},addEmptySceneHelper:function(){this.makeEmptySceneHelperDroppable();
this.makeEmptySceneHelperFocusable();this.isEmptyScene()&&(this.emptySceneHelper.show(),CE.Utils.removeSceneState("empty-scene"))},addHandleMoreDisable:function(){var a=c(".motopress-content-wrapper");this.wpMore.pointPrependTo(a,"first");this.wpMore.pointPrependTo(a,"last")},makeEmptySceneHelperFocusable:function(){var a=this;c(".motopress-empty-scene-type-here").off("focusin").on("focusin",function(b){a.emptySceneTypeHereOnFocusein(b,this)})},emptySceneTypeHereOnFocusein:function(a,b){var d=this;
this.emptySceneHelper.hide().css("opacity",1);var e=c(b).closest(".motopress-row"),f=this.newBlock.clone();this.resizer.changeSpanClass(f,parent.CE.Iframe.myThis.gridObj.span.fullclass);var g={helper:c("<div />",{"data-motopress-close-type":CE.LeftBar.myThis.library.mp_text.objects.mp_text.closeType,"data-motopress-shortcode":CE.LeftBar.myThis.library.mp_text.objects.mp_text.id,"data-motopress-group":CE.LeftBar.myThis.library.mp_text.id,"data-motopress-resize":CE.LeftBar.myThis.library.mp_text.objects.mp_text.resize})},
l=CE.LeftBar.myThis.library.mp_text.objects.mp_text.parameters;if(!c.isEmptyObject(l)){var h={};c.each(l,function(a){h[a]={}});g.helper.attr("data-motopress-parameters",JSON.stringify(h))}l=CE.LeftBar.myThis.getStyleAttrs(CE.LeftBar.myThis.library.mp_text.id,CE.LeftBar.myThis.library.mp_text.objects.mp_text.id);if(!c.isEmptyObject(l)){var m={};c.each(l,function(a){m[a]={}});g.helper.attr("data-motopress-styles",JSON.stringify(m))}this.makeEditable(f,g,!0);e=this.rowHtml.clone().find(".motopress-filler-content").replaceWith(f).end();
this.makeRowEditable(e,!0);c(".motopress-content-wrapper").append(e);var k=setTimeout(function(){d.addHandleMiddle(e,parent.CE.Iframe.myThis.gridObj.span.fullclass);clearTimeout(k)},0),q=setTimeout(function(){CE.Selectable.myThis.select(f.find(".motopress-drag-handle"));d.makeDroppable();d.resizer.updateSplittableOptions(f,null,e);d.resizer.updateAllHandles();clearTimeout(q)},0);parent.CE.Save.changeContent();CE.Utils.removeSceneState("empty-scene")},makeSpanSelectable:function(a){var b=c("<div />",
{"class":"motopress-clmn-select-handle"});a.children(".motopress-helper").append(b.clone())},makeRowEditable:function(a,b){b="undefined"!==typeof b&&b;var d=this;a.each(function(){var a=c(this);CE.DragDrop.setEdgeRow(a);var f=parent.MP.Utils.getEdgeRow(a);if(!f.children(".motopress-row-helper").length){var g=c("<span />",{"class":"motopress-row-helper"}),l=c("<div />",{"class":"motopress-row-select-handle"});g.append(d.focusArea.clone(),l.clone());f.append(g.clone())}g=a.attr("data-motopress-shortcode");
!b&&g||CE.DragDrop.myThis.setAttrs(a);"undefined"===typeof a.control(CE.Controls)&&a.ce_controls({isNew:b});f=a.control(CE.Controls);!b&&g||!f||(f.stylesCtrl.setDefaultAttrs(),a="undefined"!==typeof a.attr("data-motopress-parameters")?a.attr("data-motopress-parameters"):null,f.settingsCtrl.setDefaultAttrs(a),f.stylesCtrl.save())})},makeEditable:function(a,b,d){d="undefined"!==typeof d&&d;a.each(function(){var a=c(this);CE.DragDrop.setEdgeSpan(c(this));var f=parent.MP.Utils.getEdgeSpan(a);if(!a.closest(".motopress-block-content").length){CE.DragDrop.myThis.addHelpers(a);
CE.DragDrop.myThis.resizer.makeResizable(a);CE.DragDrop.myThis.resizer.makeSplittable(a);CE.DragDrop.myThis.makeDraggable(a);CE.DragDrop.myThis.makeDroppable();"undefined"!==typeof b&&null!==b&&CE.DragDrop.myThis.setAttrs(a,b);d&&a.addClass("motopress-new-object");a.ce_controls({isNew:d});var g=a.control(CE.Controls);if(d&&g){g.stylesCtrl.setDefaultAttrs();var l="undefined"!==typeof a.attr("data-motopress-parameters")?a.attr("data-motopress-parameters"):null;g.settingsCtrl.setDefaultAttrs(l);g.stylesCtrl.save()}f=
f.children(".motopress-block-content");f.length&&(f=f.children("[data-motopress-shortcode]"),CE.DragDrop.myThis.initShortcodeController(f,d),(f=f.control(CE.Controls))&&(d?f.renderShortcode(d):f.element.trigger("render")));a.children(".motopress-clmn-select-handle").length||CE.DragDrop.myThis.makeSpanSelectable(a)}})},initShortcodeController:function(a,b){var c=a.attr("data-motopress-shortcode");b&&a.addClass("motopress-new-object");switch(c){case "mp_text":case "mp_heading":a.ce_inline_editor({isNew:b});
break;case "mp_code":a.ce_code_editor({isNew:b});break;default:a.ce_controls({isNew:b})}},makeEditableEmptySpan:function(a){if(a.length){CE.DragDrop.setEdgeSpan(a,!0,!0);a.each(function(){c(this).children(".motopress-helper").length||c(this).append(CE.DragDrop.myThis.emptySpanHelper.clone())});var b=setTimeout(function(){CE.DragDrop.myThis.makeDroppable();clearTimeout(b)},0);this.resizer.makeSplittable(a)}},addHelpers:function(a){a.each(function(){var a=c(this),d=parent.MP.Utils.getEdgeSpan(a);if(!d.children(".motopress-block-content").length&&
!d.children(".motopress-row").length){d.find("script").remove().end().wrapInner(CE.DragDrop.myThis.blockContent.clone());d.children(".motopress-block-content").children().length||d.children(".motopress-block-content").append("<div />");var e=d.find(".motopress-block-content > [data-motopress-shortcode]");e.length&&e.attr("data-motopress-shortcode")}a.children(".motopress-helper").length||(d.children(".motopress-row").length?(a.attr("data-motopress-wrapper-id",CE.DragDrop.myThis.wrapperId),CE.DragDrop.myThis.setCalcWrapperWidth(d.children(".motopress-handle-middle-in")),
a.prepend(CE.DragDrop.myThis.wrapperHelperResizer.clone()),d=null,a.closest(".motopress-row").parent(".motopress-content-wrapper").length?(d=CE.DragDrop.myThis.wrapperHelper.clone(),a.prepend(d)):a.closest('.motopress-clmn:has(".motopress-wrapper-helper")').children(".motopress-wrapper-helper"),CE.DragDrop.myThis.wrapperId++):a.append(CE.DragDrop.myThis.helper.clone()))})},setAttrs:function(a,b){this._setAttrs(a);var c=a.find("> .motopress-block-content > div");if(c.length){var e=this.getAttrsFromElement(b.draggable?
b.draggable:b.helper);this._setAttrs(c,e)}},getAttrsFromElement:function(a){var b={closeType:a.attr("data-motopress-close-type"),id:a.attr("data-motopress-shortcode"),group:a.attr("data-motopress-group"),resize:a.attr("data-motopress-resize")},c=a.attr("data-motopress-parameters");"undefined"!==typeof c&&(b.parameters=c);a=a.attr("data-motopress-styles");"undefined"!==typeof a&&(b.styles=a);return b},_setAttrs:function(a,b){if("undefined"===typeof b){var c=null;a.hasClass("motopress-row")?c=a.parent(".motopress-content-wrapper").length?
...
null)}}return a},recursiveAddHandleMiddle:function(a){a.children(".motopress-row").each(function(a){var d=CE.DragDrop.myThis.handleMiddleIn;0==a&&(c(this).prev(".motopress-outer-handle").length||c(this).before(d.clone()));a=c(this).next(".mpce-wp-more-tag");a.length?a.next(".motopress-outer-handle").length||a.after(d.clone()):c(this).next(".motopress-outer-handle").length||c(this).after(d.clone());parent.MP.Utils.getEdgeRow(c(this)).children(".motopress-clmn").each(function(){parent.MP.Utils.getEdgeSpan(c(this)).children(".motopress-row").length&&
CE.DragDrop.myThis.recursiveAddHandleMiddle(parent.MP.Utils.getEdgeSpan(c(this)))})})},addHandleMiddle:function(a,b){a.parent(("undefined"===typeof b?"":"."+b)+".motopress-clmn, .motopress-content-wrapper").children(".motopress-row").each(function(a){var b=null,b=CE.DragDrop.myThis.handleMiddleIn;0==a&&(a=c(this).prevAll(".motopress-handle-middle-in"),0==a.length?(c(this).before(b.clone()),c(this).parent().is("[data-motopress-wrapper-id]")&&CE.DragDrop.myThis.setCalcWrapperWidth(c(this).prev())):
a.each(function(a,b){0!=a&&c(b).remove()}));b=b.clone();a=c(this).nextUntil(".motopress-row",".motopress-handle-middle-in");0==a.length?(c(this).next(".mpce-wp-more-tag").length?c(this).next(".mpce-wp-more-tag").after(b):c(this).after(b),c(this).parent().is("[data-motopress-wrapper-id]")&&CE.DragDrop.myThis.setCalcWrapperWidth(b)):a.each(function(a,b){0!=a&&c(b).remove()})})},getMinAllowedSpanSize:function(a,b,c){for(var e=1,f,g=1;g<=parent.CE.Iframe.myThis.gridObj.row.col;g++)if(e=g,b){if(f=a/100*
CE.Grid.myThis.colWidthByNumber[g],this.resizer.isAllowedColSize(c,f))break}else if(this.resizer.isAllowedColSize(g,a))break;return e},canBeMoved:function(a,b,d,e,f,g,l,h){var m,k;k="undefined"===typeof a||a instanceof jQuery&&!a.length?parent.MP.Utils.getEdgeRow(a):a=null;m="undefined"===typeof b||b instanceof jQuery&&!b.length?parent.MP.Utils.getEdgeRow(b):b=null;d="undefined"===typeof d?null:d;e="undefined"===typeof e?null:e;f="undefined"===typeof f?null:f;g="undefined"===typeof g?!1:g;h="undefined"===
typeof h?!1:h;l="undefined"===typeof l?null:l;var q={},n=parent.CE.Iframe.myThis.gridObj.row.col,p=0,r=!0;if(null!==b){if(g&&"out"===g&&null!==k&&k[0]===m[0])return!0;m.children(".motopress-clmn").each(function(){parent.MP.Utils.notClone(c(this),f)&&p++})}if(p<n||null===m){var t=this,u,v,s,x,y,z,J,G=[];b=[];var D,E,I=null,K=null,B=[],A=[],F=0;if(null!==a){u=-1;D=parseFloat(a.css("width"));F=k.children(".motopress-clmn");a=F.length-1;J=!0;g&&"insert"===g&&(a++,m=null,J=!1);var M=!1;if(m){var w=m.closest(".motopress-row-edge");
k[0]===w[0]&&(M=!0)}if(1<=a){var L=this.getMinAllowedSpanSize(D,!1);z=y=0;x=!1;v=t.getSpanSizeRules(a);var N=!1;!g||"left-in"!==g&&"right-in"!==g||(N=!0);F.each(function(a){a===d&&J||(u++,s={},s.index=u,s.isWrapper=c(this).is("[data-motopress-wrapper-id]"),s.size=v[u],s.isWrapper?(M&&c(this).find(".motopress-row-edge").each(function(){c(this)[0]===m[0]&&(I=u)}),s.wrapperWidth=D/100*CE.Grid.myThis.colWidthByNumber[v[u]],s.minSpan=t.resizer.getMinChildColumn(c(this)),s.minSize=t.getMinAllowedSpanSize(D,
!0,s.minSpan),s.isAllowed=t.resizer.isAllowedColSize(s.minSpan,s.wrapperWidth)):(s.minSize=L,N&&this===l[0]&&1>=s.minSize&&(s.minSize=2),s.isAllowed=t.resizer.isAllowedColSize(v[u],D)),s.size<s.minSize?y+=s.minSize-s.size:z+=s.size-s.minSize,x||s.isAllowed||(x=!0),B.push(s))});if(x)if(y>z)r=!1;else{for(F=a=k=0;2*y!==k+a;){for(w=0;w<B.length;w++)B[w].isAllowed&&B[w].size>B[w].minSize&&k<y?(B[w].size--,k++):!B[w].isAllowed&&B[w].size<B[w].minSize&&(B[w].size++,a++);if(50<=++F){r=!1;break}}for(w=0;w<
B.length;w++)G.push(B[w].size);q.from=G}null!==I&&(K=G.length?D/100*CE.Grid.myThis.colWidthByNumber[G[I]]:D/100*CE.Grid.myThis.colWidthByNumber[v[I]])}}if(r){var H;if(g&&"out"!==g&&"insert"!==g)switch(g){case "left-in":case "right-in":for(E=parseFloat(l.css("width")),v=t.getSpanSizeRules(2),w=0;w<v.length;w++)if(H=this.getMinAllowedSpanSize(E,!1,v[w]),v[w]<H){r=!1;break}}else if(null!==m){E=K?K:parseFloat(m.css("width"));g=m.children(".motopress-clmn");var G=g.length,C;u=-1;v=t.getSpanSizeRules(p+
1);H=this.getMinAllowedSpanSize(E,!1);z=y=0;x=!1;C={index:e,isWrapper:!1,size:v[e],minSize:H,isAllowed:v[e]>=H};C.size<C.minSize?y+=C.minSize-C.size:z+=C.size-C.minSize;g.each(function(a){u++;a===e&&(A.push(C),x||C.isAllowed||(x=!0),u++);s={};s.index=u;s.isWrapper=c(this).is("[data-motopress-wrapper-id]");s.size=v[u];s.isWrapper?(s.wrapperWidth=E/100*CE.Grid.myThis.colWidthByNumber[v[u]],s.minSpan=t.resizer.getMinChildColumn(c(this)),s.minSize=t.getMinAllowedSpanSize(E,!0,s.minSpan),s.isAllowed=t.resizer.isAllowedColSize(s.minSpan,
s.wrapperWidth)):(s.minSize=H,s.isAllowed=t.resizer.isAllowedColSize(v[u],E));s.size<s.minSize?y+=s.minSize-s.size:z+=s.size-s.minSize;x||s.isAllowed||(x=!0);A.push(s)});e===G&&(A.push(C),x||C.isAllowed||(x=!0));if(x)if(y>z)r=!1;else{for(F=a=k=0;2*y!==k+a;){for(w=0;w<A.length;w++)A[w].isAllowed&&A[w].size>A[w].minSize&&k<y?(A[w].size--,k++):!A[w].isAllowed&&A[w].size<A[w].minSize&&(A[w].size++,a++);if(50<=++F){r=!1;break}}for(w=0;w<A.length;w++)b.push(A[w].size);q.to=b}}}}return p>=n||!r?(CE.DragDrop.interruptInsert=
!0,h||(parent.MP.Flash.setFlash(localStorage.getItem("blocksOverflow"),"error"),parent.MP.Flash.showMessage()),!1):Object.keys(q).length?q:!0},resize:function(a,b,d,e){e="object"===typeof e?e:{};var f=null;if(null!==a&&"undefined"!==typeof a){a=parent.MP.Utils.getEdgeRow(a).children(".motopress-clmn");var g=a.length;0<g&&g<=parent.CE.Iframe.myThis.gridObj.row.col&&(f=e.hasOwnProperty("from")?e.from:this.getSpanSizeRules(g),a.each(function(a){parent.MP.Utils.getSpanClass(c(this).prop("class").split(" "));
CE.Resizer.myThis.changeSpanClass(c(this),parent.CE.Iframe.myThis.gridObj.span["class"]+f[a])}))}if("undefined"===typeof d||"undefined"!==typeof d&&"insert"!==d)a=b.parent(),null!==a&&"undefined"!==typeof a&&(a=a.children(".motopress-clmn"),g=a.length,0<g&&g<=parent.CE.Iframe.myThis.gridObj.row.col&&(f=e.hasOwnProperty("to")?e.to:this.getSpanSizeRules(g),a.each(function(a){parent.MP.Utils.getSpanClass(c(this).prop("class").split(" "));CE.Resizer.myThis.changeSpanClass(c(this),parent.CE.Iframe.myThis.gridObj.span["class"]+
f[a])})));"undefined"===typeof d||"top-in"!==d&&"bottom-in"!==d||(parent.MP.Utils.getSpanClass(b.prop("class").split(" ")),CE.Resizer.myThis.changeSpanClass(b,parent.CE.Iframe.myThis.gridObj.span.fullclass),d="top-in"===d?1:0,b=b.closest(".motopress-row").parent(".motopress-clmn").children(".motopress-row").get(d),b=c(b),b=parent.MP.Utils.getEdgeRow(b).children(".motopress-clmn"),"undefined"!==typeof b&&b.length&&(parent.MP.Utils.getSpanClass(b.prop("class").split(" ")),CE.Resizer.myThis.changeSpanClass(b,
parent.CE.Iframe.myThis.gridObj.span.fullclass)))},getSpanSizeRules:function(a){return this.spanSizeRules[a]},generateSpanSizeRules:function(){for(var a=parent.CE.Iframe.myThis.gridObj.row.col,b=[],c=1;c<=a;c++){b[c]=[];for(var e=Math.floor(a/c),f=a%c,g=1;g<=c;g++)b[c].push(g<=f?e+1:e)}this.spanSizeRules=b},setCalcWrapperWidth:function(a){if(CE.Grid.myThis.padding){var b=2*CE.Grid.myThis.padding,c="";parent.MP.Utils.Browser.Mozilla?c="-moz-":parent.MP.Utils.Browser.Chrome&&(c="-webkit-");a.css("width",
c+"calc(100% - "+b+"px)")}},sceneEvents:function(){this.container.off("hover").hover(function(){CE.Utils.addSceneAction("container-hover")},function(){CE.Utils.removeSceneAction("container-hover")})},hideOuterHandles:function(){c(".motopress-outer-handle").addClass("motopress-outer-handle-hidden")},showOuterHandles:function(){c(".motopress-outer-handle").removeClass("motopress-outer-handle-hidden")}})}(jQuery),function(c){CE.Template=can.Control.extend({myThis:null,templates:null},{template:c("<div />",
{"class":"motopress-template",html:'<img class="motopress-template-icon"><p class="motopress-template-name"></p>'}),init:function(a,b){CE.Template.myThis=this;if(null!==CE.Template.templates){var d=this,e=[];c.each(CE.Template.templates,function(a,b){var c=d.template.clone();c.attr("data-motopress-template-id",b.id);c.children(".motopress-template-icon").attr("src",b.icon);c.children(".motopress-template-name").text(b.name);e.push(c)});this.element.append(e)}},".motopress-template click":function(a,
b){var d=a.attr("data-motopress-template-id");d&&(parent.MP.Preloader.myThis.show(),c.ajax({url:parent.motopress.ajaxUrl,type:"POST",dataType:"html",data:{action:"motopress_ce_render_template",nonce:parent.motopressCE.nonces.motopress_ce_render_template,postID:parent.motopressCE.postID,templateId:d},success:function(a){CE.Utils.removeSceneState("empty-scene");var b=c(a).find(".motopress-ce-private-styles-updates-wrapper").andSelf().filter(".motopress-ce-private-styles-updates-wrapper").children("style");
...
!0;a.blur();window.scrollTo(0,CE.Selectable.scrollY);var b=setTimeout(function(){CE.Selectable.blurFlag=!1;clearTimeout(b)},0)}return a},getFocusAreaBySelected:function(a){var b=parent.MP.Utils.getEntityTypeBySelected(a);return b.is_row?parent.MP.Utils.getEdgeRow(a).find("> .motopress-row-helper > .motopress-focus-area"):b.is_clmn?parent.MP.Utils.getEdgeSpan(a).find("> .motopress-helper > .motopress-focus-area"):a.siblings(".motopress-focus-area")}},{selectedClass:"motopress-selected",init:function(){CE.Selectable.myThis=
...
CE.Selectable.myThis.unselect()})},select:function(a){if(!1===CE.DragDrop.interruptInsert){this.unselect();var b=null;CE.Selectable.focusWithoutScroll(a.siblings(".motopress-focus-area"));a.hasClass("motopress-row-select-handle")?(a.closest(".motopress-row").addClass(this.selectedClass),b=a.closest(".motopress-row")):(a.hasClass("motopress-clmn-select-handle")?a.closest(".motopress-clmn").addClass(this.selectedClass):a.addClass(this.selectedClass).closest(".motopress-helper").nextAll('.ui-resizable-handle:not(".motopress-hide")').show(),
b=a.closest(".motopress-clmn"));CE.Utils.addSceneAction("select");parent.CE.Navbar.myThis.showObjectControlBtns(!0,!0);(b.hasClass("ce_controls")||b.hasClass("ce_inline_editor")||b.hasClass("ce_code_editor")||b.hasClass("motopress-row"))&&!CE.Dialog.myThis.element.dialog("isOpen")&&CE.Dialog.myThis.open(a)}CE.DragDrop.interruptInsert=!1},unselect:function(){var a=c(".motopress-content-wrapper ."+this.selectedClass);a.length&&(a.each(function(){c(this).removeClass(CE.Selectable.myThis.selectedClass);
c(this).hasClass("motopress-clmn")||c(this).hasClass("motopress-row")||c(this).closest(".motopress-helper").nextAll('.ui-resizable-handle:not(".motopress-hide")').hide()}),parent.CE.Navbar.myThis.hideObjectControlBtns(),CE.Dialog.myThis.element.dialog("isOpen")&&CE.Dialog.myThis.element.dialog("close"),CE.InlineEditor.curElement&&CE.InlineEditor.curElement.control().close(),CE.Selectable.blurWithoutScroll(CE.Selectable.getFocusAreaBySelected(a)),CE.Utils.removeSceneAction("select"))}})}(jQuery),function(c){c.hasOwnProperty("stellar")&&
c.stellar("refresh");c.hasOwnProperty("fn")&&c.fn.hasOwnProperty("button")&&c.fn.button.hasOwnProperty("noConflict")&&(c.fn.btn=c.fn.button.noConflict());new CE.Utils;CE.WPMore.getInstance();new CE.StyleEditor;new CE.LeftBar;new CE.ImageLibrary;new CE.WPGallery;new CE.WPMedia;new CE.WPAudio;new CE.WPVideo;new CE.Dialog;new CE.Selectable;new CE.Link;parent.MP.Editor.myThis.load()}(jQuery)}catch(L){parent.MP.Error.log(L,!0)}});
