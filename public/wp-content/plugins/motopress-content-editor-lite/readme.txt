...
* Opportunity to extend functionality with [MotoPress Addons](https://motopress.com/addons/)
* Responsive and mobile ready layouts
* Predefined layouts

= MotoPress Content Editor Pro =

Upgrade to [MotoPress Content Editor Pro](https://motopress.com/plugins/content-editor/upgrade/) to have access to the following features:
...
* [Addons](https://motopress.com/addons/)
* [Forums](https://motopress.com/forums/forum/wordpress/)
