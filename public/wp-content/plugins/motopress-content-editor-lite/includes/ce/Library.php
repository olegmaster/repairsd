...
//            ),
        ...
        $spanInnerObj = new MPCEObject(MPCEShortcode::PREFIX . 'span_inner', __("Inner Column", 'motopress-content-editor-lite'), null, null, null, MPCEObject::ENCLOSED, MPCEObject::RESIZE_NONE);
...
/* TEXT */
        ...
        $textObj->addStyle(array(
            'mp_style_classes' => array(
                ...
                'additional_description' => sprintf(__("Note: go to Dashboard - %s Settings to add Google Fonts.", 'motopress-content-editor-lite'), $motopressCESettings['brand_name'])
            )
        ));
...
/* SPACE */
        $spaceObj = new MPCEObject(MPCEShortcode::PREFIX . 'space', __("Space", 'motopress-content-editor-lite'), 'space.png', null, 60, null, MPCEObject::RESIZE_ALL);
...
/* QUOTE */
        $quotesObj = new MPCEObject(MPCEShortcode::PREFIX . 'quote', __("Quote", 'motopress-content-editor-lite'), 'quotes.png', array(
            'cite' => array(
                ...
                'default' => 'John Smith',
                'description' => __("Quote author name", 'motopress-content-editor-lite'),
            ),
            'cite_url' => array(
                'type' => 'link',
                'label' => __("Cite url", 'motopress-content-editor-lite'),
                'default' => '#',
                'description' => __("Url of the quoted author", 'motopress-content-editor-lite'),
            ),
            'quote_content' => array(
                'type' => 'longtext',
                'label' => __("Quote content", 'motopress-content-editor-lite'),
...
// WORDPRESS
        ...
        // archives
        $wpArchiveObj = new MPCEObject(MPCEShortcode::PREFIX . 'wp_archives', __("Archives", 'motopress-content-editor-lite'), 'wordpress.png', array(
            'title' => array(
                'type' => 'text',
                'label' => __("Title", 'motopress-content-editor-lite'),
        ...
        // calendar
        $wpCalendarObj = new MPCEObject(MPCEShortcode::PREFIX . 'wp_calendar', __("Calendar", 'motopress-content-editor-lite'), 'wordpress.png', array(
            'title' => array(
                'type' => 'text',
                'label' => __("Title", 'motopress-content-editor-lite'),
        ...
        // wp_categories
        $wpCategoriesObj = new MPCEObject(MPCEShortcode::PREFIX . 'wp_categories', __("Categories", 'motopress-content-editor-lite'), 'wordpress.png', array(
            'title' => array(
                'type' => 'text',
                'label' => __("Title", 'motopress-content-editor-lite'),
        ...
        $wpCustomMenuObj = new MPCEObject(MPCEShortcode::PREFIX . 'wp_navmenu', __("Custom Menu", 'motopress-content-editor-lite'), 'wordpress.png', array(
            'title' => array(
                'type' => 'text',
                'label' => __("Title", 'motopress-content-editor-lite'),
        ...
        // wp_meta
        $wpMetaObj = new MPCEObject(MPCEShortcode::PREFIX . 'wp_meta', __("Meta", 'motopress-content-editor-lite'), 'wordpress.png', array(
            'title' => array(
                'type' => 'text',
                'label' => __("Title", 'motopress-content-editor-lite'),
        ...
        // wp_pages
        $wpPagesObj = new MPCEObject(MPCEShortcode::PREFIX . 'wp_pages', __("Pages", 'motopress-content-editor-lite'), 'wordpress.png', array(
            'title' => array(
                'type' => 'text',
                'label' => __("Title", 'motopress-content-editor-lite'),
        ...
        // wp_posts
        $wpPostsObj = new MPCEObject(MPCEShortcode::PREFIX . 'wp_posts', __("Recent Posts", 'motopress-content-editor-lite'), 'wordpress.png', array(
            'title' => array(
                    'type' => 'text',
                    'label' => __("Title", 'motopress-content-editor-lite'),
        ...
        // wp_comments
        $wpRecentCommentsObj = new MPCEObject(MPCEShortcode::PREFIX . 'wp_comments', __("Recent Comments", 'motopress-content-editor-lite'), 'wordpress.png', array(
            'title' => array(
                'type' => 'text',
                'label' => __("Title", 'motopress-content-editor-lite'),
        ...
        // wp_rss
        $wpRSSObj = new MPCEObject(MPCEShortcode::PREFIX . 'wp_rss', __("RSS", 'motopress-content-editor-lite'), 'wordpress.png', array(
            'url' => array(
                'type' => 'text',
        ...
        // search
        $wpSearchObj = new MPCEObject(MPCEShortcode::PREFIX . 'wp_search', __("Search", 'motopress-content-editor-lite'), 'wordpress.png', array(
            'title' => array(
                'type' => 'text',
                'label' => __("Title", 'motopress-content-editor-lite'),
        ...
        // tag cloud
        $wpTagCloudObj = new MPCEObject(MPCEShortcode::PREFIX . 'wp_tagcloud', __("Tag Cloud", 'motopress-content-editor-lite'), 'wordpress.png', array(
            'title' => array(
                'type' => 'text',
                'label' => __("Title", 'motopress-content-editor-lite'),
        ...
        $landingTemplate = new MPCETemplate(MPCEShortcode::PREFIX . 'landing_page', __("Landing", 'motopress-content-editor-lite') . ' ' . __("Page", 'motopress-content-editor-lite'), $landingContent, 'landing-page.png');

        $callToActionTemplate = new MPCETemplate(MPCEShortcode::PREFIX . 'call_to_action_page', __("Call To Action", 'motopress-content-editor-lite') . ' ' . __("Page", 'motopress-content-editor-lite'), $callToActionContent, 'call-to-action-page.png');

        $featureTemplate = new MPCETemplate(MPCEShortcode::PREFIX . 'feature_list', __("Feature", 'motopress-content-editor-lite') . ' ' . __("List", 'motopress-content-editor-lite'), $featureContent, 'feature-list.png');

        $descriptionTemplate = new MPCETemplate(MPCEShortcode::PREFIX . 'description_page', __("Description", 'motopress-content-editor-lite') . ' ' . __("Page", 'motopress-content-editor-lite'), $descriptionContent, 'description-page.png');

        $serviceTemplate = new MPCETemplate(MPCEShortcode::PREFIX . 'service_list', __("Service", 'motopress-content-editor-lite') . ' ' . __("List", 'motopress-content-editor-lite'), $serviceContent, 'service-list.png');

        $productTemplate = new MPCETemplate(MPCEShortcode::PREFIX . 'product_page', __("Product", 'motopress-content-editor-lite') . ' ' . __("Page", 'motopress-content-editor-lite'), $productContent, 'product-page.png');
    ...
    */
    ...
    public function getIconClassList($useEmptyIcon = false) {
    	...
    	$IconList = include($motopressCESettings['plugin_dir_path'] . 'includes/ce/icon_list.php');
