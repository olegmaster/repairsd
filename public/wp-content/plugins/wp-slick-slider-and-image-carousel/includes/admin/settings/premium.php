	...
	<table class="wpos-plugin-pricing-table">
	    ...
	    <tfoot>
	     ...
	     <tbody>
			...
			<tr>
				<th>Navigation Support  <span>Thumbnail navigation support to some designs</span></th>
				<td><i class="dashicons dashicons-no-alt"></i></td>
				<td><i class="dashicons dashicons-yes"></i></td>
			</tr>
	    	<tr>
	    	...
	    	<tr>
				<th>Arrows design <span>Set arrows designs</span></th>
				<td>1</td>
				<td>8</td>
			</tr>
			<tr>
				<th>Dots Design <span>Set dots designs</span></th>
				<td>1</td>
				<td>12</td>
			</tr>
			<tr>
