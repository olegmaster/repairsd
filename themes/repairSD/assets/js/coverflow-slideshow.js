        ...
        var $covers = $(".cbImage"),
            ...
            generateClasses = function(){
                ...
                for(x=0; x<l; x++){
                    ...
                    leftfac = al - ((self.state.coverDim.x * x)/3) -  (self.state.coverDim.x/3);
                    rightfac = al + ((self.state.coverDim.x * x)/1.7) + (self.state.coverDim.x/1.7);
                    ss.insertRule(".inactiveLeft"+x+"{left:"+leftfac+"px;z-index:"+z+";margin-top:"+y*(-(x-4))+"px;}",0);
                    ss.insertRule(".inactiveRight"+x+"{left:"+rightfac+"px;z-index:"+z+";margin-top:"+y*(-(x-4))+"px}",0);
